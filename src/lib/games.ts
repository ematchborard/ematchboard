...
export const GAMES: GameConfig[] = [
  { slug: "valorant", name: "VALORANT", short: "VAL", accent: "#ff4655", category: "FPS", popular: true },
  { slug: "lol", name: "League of Legends", short: "LoL", accent: "#0ac8b9", category: "MOBA", popular: true },
  { slug: "csgo", name: "Counter-Strike 2", short: "CS2", accent: "#f5a623", category: "FPS", popular: true },
  { slug: "dota2", name: "Dota 2", short: "DOTA", accent: "#c23c2a", category: "MOBA", popular: true },
  { slug: "ow", name: "Overwatch 2", short: "OW2", accent: "#fa9c1e", category: "FPS", popular: true },
  { slug: "r6siege", name: "Rainbow Six Siege", short: "R6", accent: "#35a8dd", category: "FPS" },
  { slug: "rl", name: "Rocket League", short: "RL", accent: "#1f8efa", category: "Racing & Sports", popular: true },
  { slug: "mlbb", name: "Mobile Legends", short: "MLBB", accent: "#4a7dff", category: "MOBA" },
  { slug: "pubg", name: "PUBG", short: "PUBG", accent: "#f2a900", category: "Battle Royale" },
  { slug: "codmw", name: "Call of Duty", short: "COD", accent: "#7ac142", category: "FPS", popular: true },
  ...
  { slug: "apex", name: "Apex Legends", short: "APEX", accent: "#da292a", category: "Battle Royale", popular: true, eventsOnly: true },
  { slug: "fortnite", name: "Fortnite", short: "FN", accent: "#9d59f5", category: "Battle Royale", popular: true, eventsOnly: true },
